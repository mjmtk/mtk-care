...
@optionlists_router.get("/{list_slug}/items/", response=List[OptionListItemSchemaOut], summary="List all active items for a specific OptionList by its slug")
