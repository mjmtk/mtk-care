...
| Status | Definition | Entry Criteria | Exit Criteria | Allowed Transitions | Min Time | Max Time |
|--------|------------|----------------|---------------|-------------------|----------|----------|
| **Draft/Incomplete** | Referral started but not submitted | User begins referral entry | User completes and submits referral | → Pending - Awaiting Consent/Initial Assessment | 0 days | 30 days* |
| **Pending - Awaiting Consent/Initial Assessment** | Referral received, awaiting consent and/or assessment | Referral submitted | Consent received AND initial assessment completed | → Accepted, Declined, No Further Action Required, Closed | 0 days | 14 days* |
| **Accepted** | Client meets criteria for service | Initial assessment completed with positive outcome | Service allocation begins | → Active/Enrolled | 0 days | 7 days* |
| **Declined** | NPO decided against providing service | Initial assessment completed or other decline reason | N/A | → Reopened (supervisor approval) | N/A | N/A |
| **No Further Action Required** | Assessment determines no service needed | Initial assessment completed | N/A | → Reopened (new referral) | N/A | N/A |
| **Active/Enrolled** | Client actively receiving services | Client accepted and allocated to program | Service episode ends | → Active - Implementing Plan, Active - In Review, Service Episode Complete, Closed | 1 day | Program-specific |
| **Active - Implementing Plan** | Actively delivering services per care plan | Care plan created and approved | Review scheduled or service complete | → Active - In Review, Service Episode Complete, Closed | 1 day | 90 days* |
| **Active - In Review** | Formal review of progress and care plan | Review triggered by schedule or event | Review completed with decision | → Active - Implementing Plan, Service Episode Complete, Closed | 0 days | 7 days |
| **Closed** | Case closed before service completion | Various (see sub-statuses) | N/A | → Reopened (if applicable) | N/A | N/A |
| **Service Episode Complete** | Service delivered and episode ended | Service goals met or exit criteria reached | N/A | → Reopened (new episode) | N/A | N/A |
| **Reopened** | Previously closed case reactivated | Supervisor approval + valid reason | Case re-enters workflow | → Pending - Awaiting Consent/Initial Assessment, Active/Enrolled | 0 days | 7 days |
| **Archived** | Administrative removal | Created in error + supervisor approval | N/A | Terminal status (no transitions) | N/A | N/A |

*Triggers automatic notifications and escalations
...
- Awaiting guardian/POA response (if applicable)
- Documentation incomplete

**Declined:**
- Did not meet criteria (specify: age, location, service type)
- Referred to another organisation (capture organisation name)
- Capacity/resources unavailable
- Client declined services after assessment
- Other (requires description)

**Closed:**
- Declined consent (before service start)
- Onward referral to external organization
- Administrative closure (duplicate referral)
- Client unreachable after multiple attempts

**Service Episode Complete:**
- By mutual consent (goals achieved)
- Client/Whānau withdrew consent
- Not contactable (specify attempts: 3+ over 14 days)
- Client moved out of area
- Referred to external provider (capture details)
- Maximum service duration reached
- Client deceased
- Aged out of program
- Other (requires description)
